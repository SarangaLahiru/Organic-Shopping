...
<head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.2.1/css/all.min.css" integrity="sha512-MV7K8+y+gLIBoVD59lQIYicR65iaqukzvf/nwasF0nqhPay5w/9lJmVM2hMDcnK1OnMGCdVK+iQrJ7lzPJQd1w==" crossorigin="anonymous" referrerpolicy="no-referrer" />
     ...
     <link rel="stylesheet" href="rest3.start.css">
   ...
   .cart a{
    ...
    <header class="header1">
        ...
        <div class="cart">
            ...
            <a href="rest3.user.register.php"><i class="fa fa-user"></i></a>
        </div>
    </header>
    <div class="menu">
   ...
   <div class="pop">
    <div class="pop1">
       ...
       <img src="/myphp-1/New folder/grocery website/organic-icon.webp" alt="">
        <h4>Hello New customer please  </h4>
        <a href="rest3.user.register.php" id="regbtn">Register here!</a>
        <h5>If you already have an account <a href="rest3.login.php">Login here!</a> </h5>
       </div>
    </div>
   </div>
</div>
